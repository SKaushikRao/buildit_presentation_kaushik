  ...
  const mvps = [
    {
      number: "01",
      titleParts: [
        { text: "Real-Time Hand Tracking with ", highlight: false },
        { text: "GESTURE", highlight: true },
        { text: " Control", highlight: false },
      ],
      description: "Detect up to two hands via webcam, support basic gestures (move to rotate, pinch to grab, two-hand distance to zoom) with smooth motion and low latency.",
      align: "left",
    },
    {
      number: "02",
      titleParts: [
        { text: "Three Switchable 3D ", highlight: false },
        { text: "LEARNING", highlight: true },
        { text: " Modules", highlight: false },
      ],
      description: "Solar System exploration, interactive 3D heart manipulation, and a virtual chemistry experiment — all accessible within one web app.",
      align: "right",
    },
    {
      number: "03",
      titleParts: [
        { text: "Interactive Object ", highlight: false },
        { text: "MANIPULATION", highlight: true },
        { text: "", highlight: false },
      ],
      description: "Users can rotate planets and organs, grab and move objects, and trigger a simulated chemical reaction by bringing two test tubes together.",
      align: "left",
    },
    {
      number: "04",
      titleParts: [
        { text: "Live Hand Mesh ", highlight: false },
        { text: "OVERLAY", highlight: true },
        { text: " Preview", highlight: false },
      ],
      description: "Small on-screen webcam window displaying hand landmark mesh so users understand gesture detection visually.",
      align: "right",
    },
    {
      number: "05",
      titleParts: [
        { text: "Lightweight, ", highlight: false },
        { text: "BROWSER-BASED", highlight: true },
        { text: " Deployment", highlight: false },
      ],
      description: "Runs directly in a browser without special hardware, optimized for average laptops to ensure accessibility in rural areas.",
      align: "left",
    },
  ]
