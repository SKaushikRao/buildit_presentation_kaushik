...
const experiments = [
  {
    title: "Democratizing Experiential Learning Through Virtual Simulation",
    medium: "Solution 1",
    description: "By recreating labs, anatomy exploration, and astronomy environments in immersive 3D, we remove dependency on physical infrastructure.",
    span: "col-span-2 row-span-2",
  },
  {
    title: "Gesture-Based Interaction for Natural Learning",
    medium: "Solution 2",
    description: "Using hand tracking instead of traditional devices makes exploration intuitive, engaging, and accessible without expensive hardware.",
    span: "col-span-1 row-span-1",
  },
  {
    title: "Scalable, Low-Cost Digital Access",
    medium: "Solution 3",
    description: "A web-based platform ensures that even students in rural areas with basic devices can access high-quality simulations.",
    span: "col-span-1 row-span-2",
  },
  {
    title: "Safe, Risk-Free Experimentation",
    medium: "Solution 4",
    description: "Virtual labs allow students to perform experiments and surgical simulations without safety hazards or material costs.",
    span: "col-span-1 row-span-1",
  },
  {
    title: "Interactive 3D Visualization for Deeper Understanding",
    medium: "Solution 5",
    description: "Manipulating organs, planets, and chemical reactions in real-time enhances spatial comprehension far beyond textbooks.",
    span: "col-span-2 row-span-1",
  },
  {
    title: "Bridging the Urban–Rural Education Gap",
    medium: "Solution 6",
    description: "By delivering advanced STEM tools digitally, we bring world-class educational experiences to students who otherwise lack access to proper laboratories or training facilities.",
    span: "col-span-1 row-span-1",
  },
]
