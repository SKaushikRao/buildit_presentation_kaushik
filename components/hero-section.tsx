      ...
      <div ref={contentRef} className="flex-1 w-full">
        ...
        <SplitFlapAudioProvider>
          <div className="relative">
            <SplitFlapText text="BobTheBuilder" speed={70} />
            <div className="mt-4">
              <SplitFlapMuteToggle />
            </div>
          </div>
        ...
        <h2 className="font-[var(--font-bebas)] text-muted-foreground/60 text-[clamp(1rem,3vw,2rem)] mt-4 tracking-wide">
          Touchless 3D Education Platform transforms learning through gesture-controlled virtual simulations.
        </h2>
        ...
        <p className="mt-12 max-w-lg font-mono text-sm text-muted-foreground leading-relaxed text-justify">
          Students can explore the solar system, interact with a 3D human heart, and perform chemistry experiments — all without physical labs. Designed for accessibility, especially in rural areas, it delivers immersive, safe, and affordable STEM education directly through a browser.
        </p>
